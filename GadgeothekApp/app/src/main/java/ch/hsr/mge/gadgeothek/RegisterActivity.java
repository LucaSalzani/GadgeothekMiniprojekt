                ...
                LibraryService.register(etEmail, etPassword, etName, etStudentID, new Callback<Boolean>() {
                    ...
                    public void onCompletion(Boolean input) {
                        if (input){
                            ...
                            Toast.makeText(getApplicationContext(), R.string.RegisterNok, Toast.LENGTH_LONG).show();
                        }
                    }

                    @Override
                    public void onError(String message) {
                        Toast.makeText(getApplicationContext(), String.format("Error on register: %s", message), Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
